  ...
  head: () => ({
    meta: [
      ...
      { title: "Connectors — Connecting Growth Through Opportunities" },
      {
        name: "description",
        content:
          "Business expansion, franchise development and retail leasing platform bridging brands, investors, franchisees and landlords.",
      },
      { property: "og:site_name", content: "Connectors" },
